...
CREATE TABLE `classtype` (
  `sno` int NOT NULL,
  `classtype` varchar(25) DEFAULT NULL,
...
INSERT INTO `classtype` VALUES (1,'FIRST CLASS',5000),(2,'BUSINESS CLASS',11000),(3,'ECONOMY CLASS',400);
...
-- Dump completed on 2022-12-21 18:01:44
